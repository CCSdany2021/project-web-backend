...
3. REQUSIITOS DE INSTALACION
  ...
  - Netbeans IDE (Ulitma version)
  - Postman (verison desktop)

4. PASOS DE CONFIURACIÓN
  ...
  4.2 configuración del proyecto java
    ...
    - Compilación del proyecto  (Build > Build project)
	
  4.3 Desplegar Tomcat
 
     4.3.1 Se dspliega el proyecto en netbeans
     ...
     4.3.4 Reiniciar tomcat
      -Si el servidor tomcat estas arriba lo detenemos con el comando  (CTRL-C) limpiamos la terminal con /clear dependiendo de la terminal que estemso utilizando.
      - Levantamos el servidor nuevamente .\Catalina run dev
      - esperamos el mensaje: "Server startup"
...
6. COMO PROBAR LA API
  ...
  6.1 Iniciamos el servidor tomcat  "si no esta activo paso 4.3.4" 
