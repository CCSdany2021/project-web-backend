package com.ucompensar.dispositivos.controller;
  ...
  public class MarcaController {
      ...
      @Produces(MediaType.APPLICATION_JSON)
      public Response crear(Marca m) {
          boolean resultado = service.crear(m);
          if (resultado) {
              return Response.ok("{\"mensaje\":\"Marca creada\"}").build();
          } else {
      ...
      @Consumes(MediaType.APPLICATION_JSON)
      @Produces(MediaType.APPLICATION_JSON)
      public Response actualizar(@PathParam("id") int id, Marca m) {
          m.setId(id);
          boolean resultado = service.actualizar(m);
          if (resultado) {
              return Response.ok("{\"mensaje\":\"Marca actualizada\"}").build();
          } else {
      ...
      public Response eliminar(@PathParam("id") int id) {
          ...
          if (resultado) {
              return Response.ok("{\"mensaje\":\"Marca eliminada\"}").build();
          } else {
